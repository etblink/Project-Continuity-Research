# CCP-1 Human Cold-Start / Usability Protocol 0.3.1

Date: 2026-09-22
Status: **FROZEN REPAIRED CANDIDATE PROTOCOL — EXECUTION BLOCKED ON PROJECTION RE-AUDIT**
...
Reader 0.3.1 tests one bounded repair: expose a first-class current-orientation projection as the default starting surface.
...
- participant uses only Reader 0.3.1 and the files it exposes from `dc469718445fcb8d208d223c327318b01667749f`;
