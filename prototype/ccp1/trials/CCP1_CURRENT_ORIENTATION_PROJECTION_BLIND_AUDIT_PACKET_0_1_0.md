# CCP-1 Current Orientation Projection — Blind Audit Packet 0.1.0

Use a genuinely fresh evaluator context. Review only the materials in this packet. Do not inspect later repository history, Trial-1 answers/scores, or the repair hypothesis.
